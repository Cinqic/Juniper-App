...
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------- |
| PR #33 exact head `b1c8ed2`            | Validation run 35149644368, every job                                                                                                                                                                                                                        | PASS                |
| Merge                                  | Merge commit `31172340600da7bce3807c1ff0ec444b40325fd7`, tree identical to `b1c8ed2`                                                                                                                                                                         | PASS                |
| Post-merge `main`                      | Validation run 35151588107 at `3117234`, every job including Windows and Android                                                                                                                                                                             | PASS                |
| Tag                                    | Annotated `v0.3.0-rc.32` (tag object `0c34709`) → `3117234`, pushed once                                                                                                                                                                                     | PASS                |
| Release workflow                       | Run 35180461718: contract, Linux build and 22.04 smoke, 24.04 smoke, Windows MSI, signed Android APK, verification and provenance, publication                                                                                                               | PASS                |
| Published assets                       | Exactly the 14 files in `manifests/release-candidate.yaml`; prerelease, not draft                                                                                                                                                                            | PASS                |
| Checksums and provenance               | Downloaded assets match `SHA256SUMS.txt`; `RELEASE-PROVENANCE.json` names the tag, commit `3117234`, run 35180461718, release URL, and the same hashes                                                                                                       | PASS                |
| Attestations                           | `gh attestation verify` on all five executable artifacts: commit `3117234`, `refs/tags/v0.3.0-rc.32`                                                                                                                                                         | PASS                |
| Android signing                        | `apksigner` v2 signature, `CN=Cinqic`; certificate SHA-256 `1fae65ef…8071`, identical to the published rc.31 APK so installs can upgrade; `com.cinqic.juniper` versionCode 3032, versionName `0.3.0-rc.32`; published APK passes 21 launcher-branding checks | PASS                |
| Windows signing                        | `SIGNING-windows.txt`: `AuthenticodeStatus=NotSigned`, ProductVersion `0.3.0.32`                                                                                                                                                                             | ACCEPTED LIMITATION |
| Published AppImage on FLOWBOX real X11 | FUSE and extract-and-run, fresh and stored Ollama state                                                                                                                                                                                                      | PASS                |
